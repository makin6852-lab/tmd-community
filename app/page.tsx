        ...
        <section className="relative min-h-screen flex items-center px-6 md:px-20 py-20 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center w-full relative z-10">
            ...
            <div>
              ...
              {/* ✅ ONLY BUTTON CHANGED HERE */}
              <div className="flex flex-col items-start">
                <a
                  href="#soon"
                  className="
                    relative overflow-hidden rounded-[26px] px-10 py-5 font-black inline-flex items-center text-white
                    border border-white/15 backdrop-blur-2xl bg-white/5
